    <article class="match_card">
        ...
        <div class="match_card-teams">
            <div class="match_card-teamInfos">
                <a class="teamInfos_name" href="<?php the_permalink(27)?>"><?php $ekip1 = get_field('equipe_1'); 
                    echo $ekip1;?>
                </a>
            ...
            <div class="match_card-teamInfos">
                <a class="teamInfos_name" href="<?php the_permalink(21)?>"><?php $ekip2 = get_field('equipe_2'); 
                    echo $ekip2;?>
                </a>
